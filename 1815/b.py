...
def main():
    ...
    initial_elves = len([unit for unit in world.units.values() if unit.kind == ELF])

    print('Elf attack power:', ATTACK_POWER[ELF])
    ...
    final_elves = len([unit for unit in world.units.values() if unit.kind == ELF])

    if not final_elves:
        print(f'Goblins win with {world.get_total_hit_points()} hit points left')
    elif final_elves < initial_elves:
        print(f'Elves win with {initial_elves - final_elves} casualties')
    else:
        print('*************************************')
        print('*** Elves win with no casualties! ***')
        print('*************************************')
...
class World:
    ...
    def take_turn(self, pos, *, _move_only=False):
        ...
        if enemies:
            ...
            enemy.hit_points -= ATTACK_POWER[unit.kind]
    ...
    def get_outcome(self):
        return self.completed_rounds * self.get_total_hit_points()
